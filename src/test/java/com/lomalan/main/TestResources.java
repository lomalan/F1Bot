...
public final class TestResources {
    ...
    public static Race createNextRace(LocalDateTime raceDate) {
        ...
        return Race.builder().date(date).time(time).quali(event).firstPractice(event).secondPractice(event)
                .thirdPractice(event).circuit(Circuit.builder().location(createLocation()).build()).build();
    }
