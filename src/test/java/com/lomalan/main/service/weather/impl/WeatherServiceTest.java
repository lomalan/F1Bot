...
public class WeatherServiceTest {
  ...
  void setup() {
    ...
    testObject =
        new WeatherService(
            f1SchedulesClient, weatherClient, telegramUserRepository, messageExecutor);
  }
  ...
  public void whenThereAreValidDateForWeatherPostingThenExecuteWeatherMessage() {
    ...
    Mockito.when(weatherClient.getWeatherOnRaceLocation(createLocation()))
    ...
    Mockito.verify(messageExecutor, Mockito.times(1))
        .executeMessage(any(), messageCaptor.capture());
  ...
  private static WeatherResponse createWeatherResponse() {
    return WeatherResponse.builder()
        ...
        .weatherInfo(WeatherInfo.builder().temp(20).feelTemp(20).humidity(0).build())
        .windSpeed("20")
        .cloudiness("0")
        .build();
  }
